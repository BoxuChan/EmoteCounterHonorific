...
public class ConfigWindow : Window
{
    ...
    public ConfigWindow(IPlayerState playerState, Config config, ExcelSheet<Emote> emoteSheet, EmoteCounterConfig emoteCounterConfig, IPluginLog pluginLog) : base("EmoteCounterHonorific - Config##configWindow")
    {
        SizeConstraints = new()
        {
